...
function terrain_ter()
    ...
    ax.plot([275], [275], [2.2], color="#ffe8d6", marker="^", markeredgecolor="black", markersize=10, alpha=1.0, linestyle="", zorder=21, clip_on=false, label=L"Une unité $u \in \mathcal{U}$  à un instant $t \in \mathcal{T}$")  
    ax.plot([800], [800], [11], color="#f8961e", marker="o", markeredgecolor="black", linestyle="", markersize=20, zorder=25, clip_on=false, label=L"Un HAPS $h \in \mathcal{H}$ déployé sur une position $e \in \mathcal{E}$")
